...
var HTTP_OK=200;var HTTP_ACCEPTED=202;var HTTP_BAD_REQUEST=400;
...
f(e);},e.onerror=function(){g(e);},e.open(c,a),d)d.hasOwnProperty(h)&&e.setRequestHeader(h,d[h]);e.send(b);})]})})},b}(AsyncUploader);
...
var ForegroundTimeTracker=/** @class */function(){function a(a){this.isTrackerActive=!1,this.localStorageName="",this.startTime=0,this.totalTime=0,this.localStorageName="mprtcl-tos-".concat(a),this.timerVault=new LocalStorageVault(this.localStorageName),this.loadTimeFromStorage(),this.addHandlers(),!1===document.hidden&&this.startTracking();}return a.prototype.addHandlers=function(){var a=this;// when user switches tabs or minimizes the window
...
if(a._Store.sessionId||b.messageType===Types.MessageType.OptOut||a._Store.webviewBridgeEnabled){var h=__assign({},b.customFlags),i=a._Store.integrationAttributes;// https://go.mparticle.com/work/SQDSDKS-5053
if(a._Helpers.getFeatureFlag&&a._Helpers.getFeatureFlag(Constants.FeatureFlags.CaptureIntegrationSpecificIds)){a._IntegrationCapture.capture();var j=a._IntegrationCapture.getClickIdsAsCustomFlags();h=__assign(__assign({},j),h);var k=a._IntegrationCapture.getClickIdsAsIntegrationAttributes();i=__assign(__assign({},k),i);}f=b.hasOwnProperty("toEventAPIObject")?b.toEventAPIObject():{// This is an artifact from v2 events where SessionStart/End and AST event
...
for(var e,f=window.mParticle,g=window.mParticle,h=0,i=d;h<i.length;h++)// Keep track of the parent object
e=i[h],g=f,f=f[e];// Apply the function with its proper context
f.apply(g,b);}catch(a){throw new Error("Unable to compute proper mParticle function "+a)}}};

var Messages$2=Constants.Messages,HTTPCodes$2=Constants.HTTPCodes,FeatureFlags$1=Constants.FeatureFlags,IdentityMethods$1=Constants.IdentityMethods,ErrorMessages=Messages$2.ErrorMessages,CacheIdentity=FeatureFlags$1.CacheIdentity,Identify=IdentityMethods$1.Identify,Modify$1=IdentityMethods$1.Modify,Login=IdentityMethods$1.Login,Logout=IdentityMethods$1.Logout;function Identity(t){var r=t._Helpers,s=r.getFeatureFlag,i=r.extend,n=this;// https://go.mparticle.com/work/SQDSDKS-6353
/**
...
return t._Helpers.getFeatureFlag(FeatureFlags$1.AudienceAPI)?void(null===s.audienceManager&&(s.audienceManager=new AudienceManager(t._Store.SDKConfig.userAudienceUrl,t._Store.devToken,t.Logger,e)),s.audienceManager.sendGetUserAudienceRequest(e,r)):void t.Logger.error(ErrorMessages.AudienceAPINotEnabled)}}},this.mParticleUserCart=function(e){return {/**
             ...
             * @deprecated
             */getCartProducts:function getCartProducts(){return t.Logger.warning("Deprecated function Identity.getCurrentUser().getCart().getCartProducts() will be removed in future releases"),t._Persistence.getCartProducts(e)}}},this.parseIdentityResponse=function(r,i,a,d,o,g,l){var u,p,y,c=t.Identity.getUser(i),I=c?c.getMPID():null,_=c?c.getUserIdentities().userIdentities:{},v={};t._Store.identityCallInFlight=!1;try{var m,S,b;if(t.Logger.verbose("Parsing \""+o+"\" identity response from server"),p=null!==(m=r.responseText)&&void 0!==m?m:null,t._Store.isLoggedIn=(null===(S=p)||void 0===S?void 0:S.is_logged_in)||!1,hasMPIDChanged(c,p)&&(t._Store.mpid=p.mpid,c&&t._Persistence.setLastSeenTime(i),u=!t._Persistence.getFirstSeenTime(p.mpid),t._Persistence.setFirstSeenTime(p.mpid)),r.status===HTTP_OK){s(CacheIdentity)&&cacheOrClearIdCache(o,g,n.idCache,r,l);var A=n.IdentityAPI.getUser(p.mpid),P=A?A.getUserIdentities().userIdentities:{};o===Modify$1?(v=t._Identity.IdentityRequest.combineUserIdentities(_,d.userIdentities),t._Store.setUserIdentities(i,v)):(o===Identify&&c&&p.mpid===I&&t._Persistence.setFirstSeenTime(p.mpid),t._Store.addMpidToSessionHistory(p.mpid,i),t._CookieSyncManager.attemptCookieSync(p.mpid,u),t._Persistence.swapCurrentUser(i,p.mpid,t._Store.currentSessionMPIDs),d&&!isEmpty(d.userIdentities)&&(v=n.IdentityRequest.combineUserIdentities(P,d.userIdentities)),t._Store.setUserIdentities(p.mpid,v),t._Persistence.update(),t._Store.syncPersistenceData(),t._Persistence.findPrevCookiesBasedOnUI(d),t._Store.context=p.context||t._Store.context),y=t.Identity.getCurrentUser(),tryOnUserAlias(c,y,d,t.Logger);var U=t._Persistence.getPersistence();y&&(t._Persistence.storeDataInMemory(U,y.getMPID()),n.reinitForwardersOnUserChange(c,y),n.setForwarderCallbacks(y,o));var C=IdentityType.getNewIdentitiesByName(v),k=o===Modify$1?_:P;// https://go.mparticle.com/work/SQDSDKS-6501
n.sendUserIdentityChangeEvent(C,o,p.mpid,k);}if(a){var f=0===r.status?HTTPCodes$2.noHttpCoverage:r.status;t._Helpers.invokeCallback(a,f,p||null,y);}else p&&!isEmpty(p.errors)&&// https://go.mparticle.com/work/SQDSDKS-6500
...
var HTTPCodes$1=Constants.HTTPCodes,Messages$1=Constants.Messages,IdentityMethods=Constants.IdentityMethods,Modify=IdentityMethods.Modify;function IdentityAPIClient(a){this.sendAliasRequest=function(b,c){return __awaiter(this,void 0,void 0,function(){var d,e,f,g,h,i,j,k,l,m,n,o,p,q,s,t,u,p;return __generator(this,function(v){switch(v.label){case 0:d=a.Logger,e=d.verbose,f=d.error,g=a._Helpers.invokeAliasCallback,h=a._Store.SDKConfig.aliasUrl,i=a._Store.devToken,e(Messages$1.InformationMessages.SendAliasHttp),j="https://".concat(h).concat(i,"/Alias"),k=window.fetch?new FetchUploader(j):new XHRUploader(j),l={method:"post",headers:{Accept:"text/plain;charset=UTF-8","Content-Type":"application/json"},body:JSON.stringify(b)},v.label=1;case 1:return v.trys.push([1,13,,14]),[4/*yield*/,k.upload(l)];case 2:return m=v.sent(),n=void 0,o=void 0,p=void 0,q=m.status,q===HTTP_ACCEPTED?[3/*break*/,3]:q===HTTP_OK?[3/*break*/,3]:q===HTTP_BAD_REQUEST?[3/*break*/,4]:[3/*break*/,11];case 3:return o="Received Alias Response from server: "+JSON.stringify(m.status),[3/*break*/,12];case 4:if(!m.json)return [3/*break*/,9];v.label=5;case 5:return v.trys.push([5,7,,8]),[4/*yield*/,m.json()];case 6:return n=v.sent(),[3/*break*/,8];case 7:return v.sent(),e("The request has no response body"),[3/*break*/,8];case 8:return [3/*break*/,10];case 9:s=m,n=s.responseText?JSON.parse(s.responseText):"",v.label=10;case 10:return t=n,(null===t||void 0===t?void 0:t.message)&&(p=t.message),o="Issue with sending Alias Request to mParticle Servers, received HTTP Code of "+m.status,(null===t||void 0===t?void 0:t.code)&&(o+=" - "+t.code),[3/*break*/,12];case 11:throw new Error("Received HTTP Code of "+m.status);case 12:return e(o),g(c,m.status,p),[3/*break*/,14];case 13:return u=v.sent(),p=u.message||u.toString(),f("Error sending alias request to mParticle servers. "+p),g(c,HTTPCodes$1.noHttpCoverage,p),[3/*break*/,14];case 14:return [2/*return*/]}})})},this.sendIdentityRequest=function(b,c,d,e,f,g,h){return __awaiter(this,void 0,void 0,function(){var i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,w;return __generator(this,function(y){switch(y.label){case 0:if(i=a.Logger,j=i.verbose,k=i.error,l=a._Helpers.invokeCallback,j(Messages$1.InformationMessages.SendIdentityBegin),!b)return k(Messages$1.ErrorMessages.APIRequestEmpty),[2/*return*/];if(j(Messages$1.InformationMessages.SendIdentityHttp),a._Store.identityCallInFlight)return l(d,HTTPCodes$1.activeIdentityRequest,"There is currently an Identity request processing. Please wait for this to return before requesting again"),[2/*return*/];m=g||null,n=this.getUploadUrl(c,g),o=window.fetch?new FetchUploader(n):new XHRUploader(n),p={method:"post",headers:{Accept:"text/plain;charset=UTF-8","Content-Type":"application/json","x-mp-key":a._Store.devToken},body:JSON.stringify(b)},a._Store.identityCallInFlight=!0,y.label=1;case 1:return y.trys.push([1,9,,10]),[4/*yield*/,o.upload(p)];case 2:return q=y.sent(),r=void 0,s=void 0,t=q.status,t===HTTP_ACCEPTED?[3/*break*/,3]:t===HTTP_OK?[3/*break*/,3]:t===HTTP_BAD_REQUEST?[3/*break*/,3]:[3/*break*/,7];case 3:return q.json?[4/*yield*/,q.json()]:[3/*break*/,5];case 4:return u=y.sent(),r=this.getIdentityResponseFromFetch(q,u),[3/*break*/,6];case 5:r=this.getIdentityResponseFromXHR(q),y.label=6;case 6:return r.status===HTTP_BAD_REQUEST?(v=r.responseText,s="Issue with sending Identity Request to mParticle Servers, received HTTP Code of "+r.status,(null===v||void 0===v?void 0:v.Errors)&&(w=v.Errors.map(function(a){return a.message}).join(", "),s+=" - "+w)):(s="Received Identity Response from server: ",s+=JSON.stringify(r.responseText)),[3/*break*/,8];case 7:throw new Error("Received HTTP Code of "+q.status);case 8:return a._Store.identityCallInFlight=!1,j(s),f(r,m,d,e,c,h,!1),[3/*break*/,10];case 9:return x=y.sent(),a._Store.identityCallInFlight=!1,w=x.message||x.toString(),k("Error sending identity request to servers - "+w),l(d,HTTPCodes$1.noHttpCoverage,w),[3/*break*/,10];case 10:return [2/*return*/]}})})},this.getUploadUrl=function(b,c){var d=a._Helpers.createServiceUrl(a._Store.SDKConfig.identityUrl),e=b===Modify?d+c+"/"+b:d+b;return e},this.getIdentityResponseFromFetch=function(a,b){return {status:a.status,responseText:b,cacheMaxAge:parseInt(a.headers.get(CACHE_HEADER))||0,expireTimestamp:0}},this.getIdentityResponseFromXHR=function(a){return {status:a.status,responseText:a.responseText?JSON.parse(a.responseText):{},cacheMaxAge:parseNumber(a.getResponseHeader(CACHE_HEADER)||""),expireTimestamp:0}};}
...
var RoktManager=/** @class */function(){function a(){this.launcher=null,this.messageQueue=[],this.launcher=null;}return a.prototype.attachLauncher=function(a){this.setLauncher(a),this.processMessageQueue();},a.prototype.selectPlacements=function(a){if(!this.launcher)return this.queueMessage({methodName:"selectPlacements",payload:a}),Promise.resolve({});try{return this.launcher.selectPlacements(a)}catch(a){return Promise.reject(a instanceof Error?a:new Error("Unknown error occurred"))}},a.prototype.processMessageQueue=function(){var a=this;0<this.messageQueue.length&&(this.messageQueue.forEach(function(b){return __awaiter(a,void 0,void 0,function(){return __generator(this,function(a){switch(a.label){case 0:return this.launcher&&b.methodName in this.launcher?[4/*yield*/,this.launcher[b.methodName](b.payload)]:[3/*break*/,2];case 1:a.sent(),a.label=2;case 2:return [2/*return*/]}})})}),this.messageQueue=[]);},a.prototype.queueMessage=function(a){this.messageQueue.push(a);},a.prototype.setLauncher=function(a){this.launcher=a;},a}();
...
module.exports = mParticleManager;
